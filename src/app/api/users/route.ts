        ...
        if (existingUser) {
            ...
            return NextResponse.json({
                ...
                user: {
                    ...
                    isAdmin,
                    // Include all profile fields so autofill works immediately after login
                    ...
                    ...(existingUser.panCard && { panCard: existingUser.panCard }),
                    ...(existingUser.aadharCard && { aadharCard: existingUser.aadharCard }),
                },
            });
        } else {

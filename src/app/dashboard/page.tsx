...
export default function DashboardPage() {
    ...
    useEffect(() => {
        ...
        allContracts.forEach(c => {
            ...
            if (c.status === ContractStatus.APPROVED) approved++;
            // Note: WAITING_FOR_SIGNATURE is currently not counted in stats cards based on user request to prioritize 'Approved'

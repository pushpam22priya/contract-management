...
export default function OverviewDrawer({ activeTab, stats, onClose, onTabChange }: OverviewDrawerProps) {
    ...
    const statRows = [
        ...
        },
        {
            ...
            color: '#ed3a88',
            path: '/overview?status=DRAFT,IN_REVIEW,IN_APPROVAL,REVIEW_APPROVAL,REVIEWED',
        },
        {
        ...
        },
        {
            ...
            color: '#2563eb',
            path: '/overview?status=SIGNED_BY_EVERYONE',
        },
        {
            label: t('activeContracts'),

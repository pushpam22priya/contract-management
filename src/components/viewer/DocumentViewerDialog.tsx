...
export default function DocumentViewerDialog({
    ...
    const handleSaveClick = async () => {
        ...
        try {
            ...
            // CRITICAL: Pass filledFieldValues so PDFViewer can use them for export
            // (same pattern as CreateContractDialog)
            console.log('📝 [DocumentViewerDialog] Exporting with field values:', filledFieldValues);
            const updatedXfdf = await pdfViewerRef.current.exportAnnotations(filledFieldValues);
